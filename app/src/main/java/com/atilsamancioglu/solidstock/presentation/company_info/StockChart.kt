...
fun StockChart(
    ...
    //we pass infos to remember, so it would be recalculated if infos change
    ...
    //android graphics paint does not take sp as value, we need to convert it into px
    //however we still need responsiveness so we use localdensity
    ...
    Canvas(modifier = modifier) {
        ...
        // x axis hours. we don't have drawtext in canvas so we need to do it with nativecanvas
